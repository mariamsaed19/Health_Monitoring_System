package com.example.servingLayer;
...
public class BatchViewGenerator extends Configured implements Tool{
    public static void main(String[] args)  throws Exception{
        int exitFlag = ToolRunner.run(new BatchViewGenerator(), args);
//        System.exit(exitFlag);
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(BatchViewGenerator.class);
